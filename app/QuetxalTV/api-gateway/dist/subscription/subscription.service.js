...
let SubscriptionService = class SubscriptionService {
    ...
    onModuleInit() {
        this.grpcClient = this.client.getService('SubscriptionService');
    }
    getPlans() {
    ...
    getPlansWithRates(currency, userId) {
    ...
    getPaymentHistory(userId, limit = 10, offset = 0) {
...
exports.SubscriptionService = SubscriptionService = __decorate([
    ...
    __param(0, (0, common_1.Inject)('SUBSCRIPTION_PACKAGE')),
