...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // ─── Paleta cine clásico ───────────────────────
        parchment: "#F5F0E8",       // crema envejecido
        sepia: "#8B6914",           // dorado sepia
        film: "#2C2416",            // negro film
        reel: "#4A3728",            // café oscuro
        spotlight: "#D4A843",       // dorado spotlight
        curtain: "#8B1A1A",         // rojo telón
        silver: "#C0B99A",          // plata envejecida
      ...
      fontFamily: {
        ...
        body: ['"Inter"', 'sans-serif'],             // texto limpio
        mono: ['"DM Mono"', 'monospace'],            // detalles técnicos
      },
      backgroundImage: {
